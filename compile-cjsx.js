...
import coffee from 'coffee-react';

// https://github.com/meteor/meteor/blob/devel/packages/coffeescript/plugin/compile-coffeescript.js
// Woah, very familiar.
...
export class CoffeeReactCompiler extends CachingCompiler {
  constructor() {
    super({
      compilerName: 'coffee-react',
...
Plugin.registerCompiler({
  ...
  return new CoffeeReactCompiler();
});
